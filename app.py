...
# Load models
pickle_in_1 = open('models/xg_model_1', 'rb')
pickle_in_2 = open('models/knn_model', 'rb')
pickle_in_3 = open('models/rf_model', 'rb')
pickle_in_4 = open('models/svm_model', 'rb')
pickle_in_5 = open('models/dt_model', 'rb')
pickle_in_6 = open('models/ada_model', 'rb')

xg_boost_1 = pickle.load(pickle_in_1)
knn_model = pickle.load(pickle_in_2)
rf_model = pickle.load(pickle_in_3)
svm_model = pickle.load(pickle_in_4)
dt_model = pickle.load(pickle_in_5)
ada_model = pickle.load(pickle_in_6)
